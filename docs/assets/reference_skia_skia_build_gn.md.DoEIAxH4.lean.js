...
<span class="line"><span>import(&quot;gn/toolchain/wasm.gni&quot;)</span></span></code></pre></div><p>必要な定義や設定ファイルをインポートします。</p><h3 id="fuchsia-sdkのインポート" tabindex="-1">Fuchsia SDKのインポート <a class="header-anchor" href="#fuchsia-sdkのインポート" aria-label="Permalink to &quot;Fuchsia SDKのインポート&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (is_fuchsia) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>Fuchsiaプラットフォーム向けのSDKをインポートします。</p><h3 id="dawnライブラリのインポート" tabindex="-1">Dawnライブラリのインポート <a class="header-anchor" href="#dawnライブラリのインポート" aria-label="Permalink to &quot;Dawnライブラリのインポート&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (skia_use_dawn) {</span></span>
<span class="line"><span>  import(&quot;//third_party/externals/dawn/scripts/dawn_features.gni&quot;)</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>Dawnライブラリを使用する場合、その定義をインポートします。</p><h3 id="カスタム設定のインポート" tabindex="-1">カスタム設定のインポート <a class="header-anchor" href="#カスタム設定のインポート" aria-label="Permalink to &quot;カスタム設定のインポート&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (defined(skia_settings)) {</span></span>
<span class="line"><span>  import(skia_settings)</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>カスタム設定が定義されている場合、それをインポートします。</p><h3 id="ios設定のインポート" tabindex="-1">iOS設定のインポート <a class="header-anchor" href="#ios設定のインポート" aria-label="Permalink to &quot;iOS設定のインポート&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import(&quot;gn/ios.gni&quot;)</span></span></code></pre></div><p>iOS向けの設定をインポートします。</p><h3 id="skia-public-apiの設定" tabindex="-1">Skia Public APIの設定 <a class="header-anchor" href="#skia-public-apiの設定" aria-label="Permalink to &quot;Skia Public APIの設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>config(&quot;skia_public&quot;) {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>SkiaのパブリックAPIに関連する設定を定義します。様々なプラットフォームや機能に応じてコンパイルオプションや定義を追加しています。</p><h3 id="skia-private-apiの設定" tabindex="-1">Skia Private APIの設定 <a class="header-anchor" href="#skia-private-apiの設定" aria-label="Permalink to &quot;Skia Private APIの設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>config(&quot;skia_private&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>Skiaの内部APIに関連する設定を定義します。開発ビルドや特定の機能に応じた定義を追加しています。</p><h3 id="skiaライブラリの設定" tabindex="-1">Skiaライブラリの設定 <a class="header-anchor" href="#skiaライブラリの設定" aria-label="Permalink to &quot;Skiaライブラリの設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>config(&quot;skia_library&quot;) {</span></span>
<span class="line"><span>  visibility = [ &quot;./*&quot; ]</span></span>
<span class="line"><span>  defines = [ &quot;SKIA_IMPLEMENTATION=1&quot; ]</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>Skiaライブラリに関連する設定を定義します。</p><h3 id="skiaライブラリの設定をまとめたリスト" tabindex="-1">Skiaライブラリの設定をまとめたリスト <a class="header-anchor" href="#skiaライブラリの設定をまとめたリスト" aria-label="Permalink to &quot;Skiaライブラリの設定をまとめたリスト&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>skia_library_configs = [</span></span>
...
<span class="line"><span>]</span></span></code></pre></div><p>Skiaライブラリの設定を一つのリストにまとめています。</p><h3 id="cpu特化のskiaコード用テンプレート" tabindex="-1">CPU特化のSkiaコード用テンプレート <a class="header-anchor" href="#cpu特化のskiaコード用テンプレート" aria-label="Permalink to &quot;CPU特化のSkiaコード用テンプレート&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>template(&quot;opts&quot;) {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>CPU特化のSkiaコードをビルドするためのテンプレートを定義します。有効化されている場合、特定の設定を適用し、無効化されている場合は空のターゲットを作成します。</p><h3 id="プラットフォームの確認と最適化オプションの設定" tabindex="-1">プラットフォームの確認と最適化オプションの設定 <a class="header-anchor" href="#プラットフォームの確認と最適化オプションの設定" aria-label="Permalink to &quot;プラットフォームの確認と最適化オプションの設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>is_x86 = current_cpu == &quot;x64&quot; || current_cpu == &quot;x86&quot;</span></span></code></pre></div><p><code>is_x86</code>変数は、現在のCPUアーキテクチャがx64またはx86であるかどうかを確認しています。</p><h3 id="haswell向けの最適化設定" tabindex="-1">Haswell向けの最適化設定 <a class="header-anchor" href="#haswell向けの最適化設定" aria-label="Permalink to &quot;Haswell向けの最適化設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>opts(&quot;hsw&quot;) {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>このブロックは、Haswellアーキテクチャ向けの最適化設定を定義しています。x86アーキテクチャの場合、有効化されます。Windowsプラットフォームでは<code>/arch:AVX2</code>、それ以外のプラットフォームでは<code>-march=haswell</code>フラグを使用します。</p><h3 id="skylake向けの最適化設定" tabindex="-1">Skylake向けの最適化設定 <a class="header-anchor" href="#skylake向けの最適化設定" aria-label="Permalink to &quot;Skylake向けの最適化設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>opts(&quot;skx&quot;) {</span></span>
<span class="line"><span>  enabled = is_x86</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>このブロックは、Skylakeアーキテクチャ向けの最適化設定を定義しています。x86アーキテクチャの場合、有効化されます。Windowsプラットフォームでは<code>/arch:AVX512</code>、それ以外のプラットフォームでは<code>-march=skylake-avx512</code>フラグを使用します。</p><h3 id="オプション機能のテンプレート" tabindex="-1">オプション機能のテンプレート <a class="header-anchor" href="#オプション機能のテンプレート" aria-label="Permalink to &quot;オプション機能のテンプレート&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>template(&quot;optional&quot;) {</span></span>
<span class="line"><span>  if (invoker.enabled) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、Android用のフォントマネージャーを有効化します。必要な依存関係として、FreeTypeとexpatライブラリが指定されています。関連するヘッダーファイルやソースファイルが定義され、テスト用のソースファイルも含まれています。</p><h3 id="カスタムフォントマネージャーのオプション設定" tabindex="-1">カスタムフォントマネージャーのオプション設定 <a class="header-anchor" href="#カスタムフォントマネージャーのオプション設定" aria-label="Permalink to &quot;カスタムフォントマネージャーのオプション設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>optional(&quot;fontmgr_custom&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、カスタムディレクトリフォントマネージャーを有効化します。関連するヘッダーファイルとソースファイルが定義されています。</p><h3 id="カスタム埋め込みフォントマネージャーのオプション設定" tabindex="-1">カスタム埋め込みフォントマネージャーのオプション設定 <a class="header-anchor" href="#カスタム埋め込みフォントマネージャーのオプション設定" aria-label="Permalink to &quot;カスタム埋め込みフォントマネージャーのオプション設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>optional(&quot;fontmgr_custom_embedded&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、カスタム埋め込みフォントマネージャーを有効化します。関連するソースファイルが定義されています。</p><h3 id="カスタム空フォントマネージャーのオプション設定" tabindex="-1">カスタム空フォントマネージャーのオプション設定 <a class="header-anchor" href="#カスタム空フォントマネージャーのオプション設定" aria-label="Permalink to &quot;カスタム空フォントマネージャーのオプション設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>optional(&quot;fontmgr_custom_empty&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、カスタム空フォントマネージャーを有効化します。関連するヘッダーファイルとソースファイルが定義されています。</p><h3 id="fontconfigフォントマネージャーのオプション設定" tabindex="-1">Fontconfigフォントマネージャーのオプション設定 <a class="header-anchor" href="#fontconfigフォントマネージャーのオプション設定" aria-label="Permalink to &quot;Fontconfigフォントマネージャーのオプション設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>optional(&quot;fontmgr_fontconfig&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、Fontconfigフォントマネージャーを有効化します。Fontconfigライブラリに依存しており、関連するヘッダーファイル、ソースファイル、テストファイルが定義されています。</p><h3 id="fontconfiginterfaceフォントマネージャーのオプション設定" tabindex="-1">FontConfigInterfaceフォントマネージャーのオプション設定 <a class="header-anchor" href="#fontconfiginterfaceフォントマネージャーのオプション設定" aria-label="Permalink to &quot;FontConfigInterfaceフォントマネージャーのオプション設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>optional(&quot;fontmgr_FontConfigInterface&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、FontConfigInterfaceフォントマネージャーを有効化します。Fontconfigライブラリに依存しており、関連するヘッダーファイル、ソースファイル、テストファイルが定義されています。</p><h3 id="fuchsia用フォントマネージャーのオプション設定" tabindex="-1">Fuchsia用フォントマネージャーのオプション設定 <a class="header-anchor" href="#fuchsia用フォントマネージャーのオプション設定" aria-label="Permalink to &quot;Fuchsia用フォントマネージャーのオプション設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>optional(&quot;fontmgr_fuchsia&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、Fuchsia用のフォントマネージャーを有効化します。Fuchsia SDKに依存しており、関連するヘッダーファイルとソースファイルが定義されています。</p><h3 id="mac用coretextフォントマネージャーのオプション設定" tabindex="-1">Mac用CoreTextフォントマネージャーのオプション設定 <a class="header-anchor" href="#mac用coretextフォントマネージャーのオプション設定" aria-label="Permalink to &quot;Mac用CoreTextフォントマネージャーのオプション設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>optional(&quot;fontmgr_mac_ct&quot;) {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、Windows用のフォントマネージャーを有効化します。<code>skia_enable_fontmgr_win</code>が有効である場合に適用されます。DirectWriteを使用するための定義が追加され、関連するヘッダーファイルとソースファイルが指定されています。また、<code>skia_dwritecore_sdk</code>が指定されている場合、追加のインクルードディレクトリやコンパイルフラグが設定されます。</p><h3 id="windows用gdiフォントマネージャーのオプション設定" tabindex="-1">Windows用GDIフォントマネージャーのオプション設定 <a class="header-anchor" href="#windows用gdiフォントマネージャーのオプション設定" aria-label="Permalink to &quot;Windows用GDIフォントマネージャーのオプション設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>optional(&quot;fontmgr_win_gdi&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>このオプションは、Windows用のGDIフォントマネージャーを有効化します。<code>skia_enable_fontmgr_win_gdi</code>が有効である場合に適用され、GDI関連のヘッダーファイル、ソースファイル、ライブラリが指定されています。</p><h3 id="sksl-skia-shading-language-のlexファイルを生成する設定" tabindex="-1">SKSL（Skia Shading Language）のlexファイルを生成する設定 <a class="header-anchor" href="#sksl-skia-shading-language-のlexファイルを生成する設定" aria-label="Permalink to &quot;SKSL（Skia Shading Language）のlexファイルを生成する設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (skia_lex) {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>このブロックは、<code>skia_lex</code>が有効な場合、SKSLのlexファイルを生成するための設定を行います。<code>sksllex</code>という実行可能ファイルを生成し、<code>run_sksllex.py</code>スクリプトを実行してlexファイルを生成します。生成されたヘッダーファイルの出力先も指定されています。</p><h3 id="skslモジュールのコピー設定" tabindex="-1">SKSLモジュールのコピー設定 <a class="header-anchor" href="#skslモジュールのコピー設定" aria-label="Permalink to &quot;SKSLモジュールのコピー設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (skia_compile_modules || skia_compile_sksl_tests) {</span></span>
