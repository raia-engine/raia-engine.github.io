...
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>説明</strong>: ここでは追加のビルド引数を宣言しています。 <ul><li><code>is_debug</code>: デバッグビルドかどうかを示すフラグ。<code>is_official_build</code> が <code>false</code> の場合に <code>true</code> になります。</li><li><code>is_trivial_abi</code>: Trivial ABIを使用するかどうかを示すフラグ。<code>is_official_build</code> が <code>false</code> の場合に <code>true</code> になります。この設定はSkiaのABIに影響を与え、Skiaとその依存関係で一貫して設定する必要があります。</li></ul></li></ul><h3 id="デバッグビルドと公式ビルドの矛盾チェック" tabindex="-1">デバッグビルドと公式ビルドの矛盾チェック <a class="header-anchor" href="#デバッグビルドと公式ビルドの矛盾チェック" aria-label="Permalink to &quot;デバッグビルドと公式ビルドの矛盾チェック&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>assert(!(is_debug &amp;&amp; is_official_build))</span></span></code></pre></div><ul><li><strong>説明</strong>: デバッグビルドと公式ビルドが同時に設定されていないことを確認します。両方が同時に <code>true</code> になることは許容されません。</li></ul><h3 id="webassemblyターゲットの設定" tabindex="-1">WebAssemblyターゲットの設定 <a class="header-anchor" href="#webassemblyターゲットの設定" aria-label="Permalink to &quot;WebAssemblyターゲットの設定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (target_cpu == &quot;wasm&quot;) {</span></span>
<span class="line"><span>  target_os = &quot;wasm&quot;</span></span>
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>説明</strong>: <code>target_cpu</code> が <code>&quot;wasm&quot;</code> の場合、<code>target_os</code> を <code>&quot;wasm&quot;</code> に設定します。</li></ul><h3 id="プラットフォームの検出" tabindex="-1">プラットフォームの検出 <a class="header-anchor" href="#プラットフォームの検出" aria-label="Permalink to &quot;プラットフォームの検出&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (target_os == &quot;&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>説明</strong>: <ul><li><code>target_os</code> が空の場合、<code>host_os</code> を <code>target_os</code> に設定します。</li><li>さらに、<code>ndk</code> が設定されている場合、<code>target_os</code> を <code>&quot;android&quot;</code> に設定します。</li><li><code>current_os</code> が空の場合、<code>current_os</code> を <code>target_os</code> に設定します。</li></ul></li></ul><h3 id="プラットフォームのフラグ設定" tabindex="-1">プラットフォームのフラグ設定 <a class="header-anchor" href="#プラットフォームのフラグ設定" aria-label="Permalink to &quot;プラットフォームのフラグ設定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>is_android = current_os == &quot;android&quot;</span></span>
...
<span class="line"><span>is_apple = is_mac || is_ios</span></span></code></pre></div><ul><li><strong>説明</strong>: <ul><li><code>is_chromeos</code>: <code>false</code> に設定。これはDawnのビルドファイルのために存在しますが、Skia自体には影響しません。</li><li><code>is_apple</code>: <code>is_mac</code> または <code>is_ios</code> が <code>true</code> の場合に <code>true</code>。これはANGLEのビルドファイルのために存在します。</li></ul></li></ul><h3 id="ターゲットcpuの設定" tabindex="-1">ターゲットCPUの設定 <a class="header-anchor" href="#ターゲットcpuの設定" aria-label="Permalink to &quot;ターゲットCPUの設定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (target_cpu == &quot;&quot;) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>説明</strong>: <ul><li><code>target_cpu</code> が空の場合、<code>host_cpu</code> を <code>target_cpu</code> に設定します。</li><li>さらに、<code>is_android</code> または <code>is_ios</code> が <code>true</code> の場合、<code>target_cpu</code> を <code>&quot;arm64&quot;</code> に設定します。</li><li><code>target_cpu</code> が <code>&quot;x86_64&quot;</code> の場合、<code>target_cpu</code> を <code>&quot;x64&quot;</code> に設定します。</li><li><code>current_cpu</code> が空の場合、<code>current_cpu</code> を <code>target_cpu</code> に設定します。</li></ul></li></ul><h3 id="clangコンパイラの判定" tabindex="-1">Clangコンパイラの判定 <a class="header-anchor" href="#clangコンパイラの判定" aria-label="Permalink to &quot;Clangコンパイラの判定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>is_clang = is_android || is_ios || is_mac || is_fuchsia || is_wasm ||</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>説明</strong>: <ul><li><code>is_clang</code> は、以下のいずれかの条件が満たされた場合に <code>true</code> になります: <ul><li><code>is_android</code>, <code>is_ios</code>, <code>is_mac</code>, <code>is_fuchsia</code>, <code>is_wasm</code> のいずれかが <code>true</code></li><li><code>cc</code> が <code>&quot;clang&quot;</code> で <code>cxx</code> が <code>&quot;clang++&quot;</code></li><li><code>clang_win</code> が空でない</li></ul></li><li>これらの条件に当てはまらず、かつ <code>is_win</code> でもない場合、スクリプト <code>is_clang.py</code> を実行して <code>cc</code> と <code>cxx</code> を引数に渡し、Clangコンパイラであるかを判定します。</li></ul></li></ul><h3 id="android-ndkの設定" tabindex="-1">Android NDKの設定 <a class="header-anchor" href="#android-ndkの設定" aria-label="Permalink to &quot;Android NDKの設定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (is_android) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>説明</strong>: <ul><li><code>target_os</code> が <code>&quot;win&quot;</code> の場合、MSVCコンパイラのインストール場所を検出します。</li><li>デフォルトでは、Visual Studio 2017（Enterprise、Pro、Community）の順に探し、それが見つからなければ2015を探します。MSVCがデフォルト以外の場所にインストールされている場合は、<code>win_vc</code> を設定して場所を指定できます。</li><li><code>win_vc</code> が空の場合、スクリプト <code>find_msvc.py</code> を実行してMSVCのインストール場所を取得します。</li><li><code>win_vc</code> が空でないことを確認するために <code>assert</code> を使用し、空の場合はエラーメッセージを出力します。</li></ul></li></ul><h3 id="windowsプラットフォームの設定" tabindex="-1">Windowsプラットフォームの設定 <a class="header-anchor" href="#windowsプラットフォームの設定" aria-label="Permalink to &quot;Windowsプラットフォームの設定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (target_os == &quot;win&quot;) {</span></span></code></pre></div><ul><li><strong>説明</strong>: この部分は、ターゲットOSがWindowsである場合にのみ実行される設定を含んでいます。</li></ul><h3 id="visual-studioツールチェインのバージョン設定" tabindex="-1">Visual Studioツールチェインのバージョン設定 <a class="header-anchor" href="#visual-studioツールチェインのバージョン設定" aria-label="Permalink to &quot;Visual Studioツールチェインのバージョン設定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  if (win_toolchain_version == &quot;&quot;) {</span></span>
...
<span class="line"><span>                                  ],</span></span>
<span class="line"><span>                                  &quot;trim string&quot;)</span></span>
<span class="line"><span>  }</span></span></code></pre></div><ul><li><strong>説明</strong>: <ul><li><code>win_sdk_version</code> が空の場合、スクリプト <code>highest_version_dir.py</code> を実行して、Windows SDKのバージョンを取得します。</li><li>スクリプトには、<code>$win_sdk/Include</code> ディレクトリと、バージョン形式を指定する正規表現 <code>[0-9]{2}\\.[0-9]\\.[0-9]{5}\\.[0-9]</code> を渡します。</li><li>結果を <code>trim string</code> 形式で返し、<code>win_sdk_version</code> に設定します。</li></ul></li></ul><h3 id="clang-for-windowsのバージョン設定" tabindex="-1">Clang for Windowsのバージョン設定 <a class="header-anchor" href="#clang-for-windowsのバージョン設定" aria-label="Permalink to &quot;Clang for Windowsのバージョン設定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  if (clang_win != &quot;&quot; &amp;&amp; clang_win_version == &quot;&quot;) {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>説明</strong>: <ul><li><strong>テンプレート名</strong>: <code>component</code></li><li><strong>目的</strong>: コンポーネントは静的ライブラリまたは共有ライブラリとして定義されます。</li><li><strong>条件</strong>: <code>is_component_build</code> が <code>true</code> の場合、<code>_component_mode</code> を <code>&quot;shared_library&quot;</code> に設定し、それ以外の場合は <code>&quot;static_library&quot;</code> に設定します。</li><li><strong>ターゲットの定義</strong>: <code>_component_mode</code> に基づいてターゲットを定義し、<code>invoker</code> からすべての変数を引き継ぎます。</li></ul></li></ul><h3 id="デフォルトコンフィグの定義" tabindex="-1">デフォルトコンフィグの定義 <a class="header-anchor" href="#デフォルトコンフィグの定義" aria-label="Permalink to &quot;デフォルトコンフィグの定義&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Default configs</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>説明</strong>: <ul><li><code>skia_header_target_default_configs</code> は、Skiaの公開ヘッダに適用されるデフォルトのビルドコンフィグのリストです。</li><li><code>is_official_build</code> が <code>false</code> の場合、公開ヘッダ用の警告設定 <code>//gn/skia:warnings_for_public_headers</code> を追加します。</li></ul></li></ul><h3 id="ツールチェインの設定" tabindex="-1">ツールチェインの設定 <a class="header-anchor" href="#ツールチェインの設定" aria-label="Permalink to &quot;ツールチェインの設定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (is_win) {</span></span>
