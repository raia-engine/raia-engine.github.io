...
<span class="line"><span>      outputs = [ &quot;{{source_out_dir}}/{{target_output_name}}.{{source_name_part}}.o&quot; ]</span></span>
<span class="line"><span>      description = &quot;compile {{source}}&quot;</span></span>
<span class="line"><span>    }</span></span></code></pre></div>`,31)),n("ul",null,[n("li",null,[s[44]||(s[44]=n("strong",null,"説明",-1)),s[45]||(s[45]=a(": ")),s[46]||(s[46]=n("code",null,"cxx",-1)),s[47]||(s[47]=a(" ツール（C++コンパイラ）の設定を行います。 ")),n("ul",null,[n("li",null,[s[39]||(s[39]=n("code",null,"cc",-1)),s[40]||(s[40]=a(" ツールとほぼ同じ設定ですが、")),s[41]||(s[41]=n("code",null,"cxx",-1)),s[42]||(s[42]=a(" コンパイラを使用し、")),n("code",null,o(l.cflags_cc),1),s[43]||(s[43]=a(" を追加しています。"))])])])]),s[101]||(s[101]=p(`<h4 id="objective-cコンパイラの設定" tabindex="-1">Objective-Cコンパイラの設定 <a class="header-anchor" href="#objective-cコンパイラの設定" aria-label="Permalink to &quot;Objective-Cコンパイラの設定&quot;">​</a></h4><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    tool(&quot;objc&quot;) {</span></span>
<span class="line"><span>      depfile = &quot;{{output}}.d&quot;</span></span>
...
<span class="line"><span>      outputs = [ &quot;{{source_out_dir}}/{{target_output_name}}.{{source_name_part}}.o&quot; ]</span></span>
<span class="line"><span>      description = &quot;compile {{source}}&quot;</span></span>
<span class="line"><span>    }</span></span></code></pre></div>`,2)),n("ul",null,[n("li",null,[s[50]||(s[50]=n("strong",null,"説明",-1)),s[51]||(s[51]=a(": ")),s[52]||(s[52]=n("code",null,"objc",-1)),s[53]||(s[53]=a(" ツール（Objective-Cコンパイラ）の設定を行います。 ")),n("ul",null,[s[49]||(s[49]=n("li",null,[n("code",null,"framework_dirs"),a(" を追加して、フレームワークディレクトリを指定します。")],-1)),n("li",null,[n("code",null,o(l.cflags_objc),1),s[48]||(s[48]=a(" を追加しています。"))])])])]),s[102]||(s[102]=p(`<h4 id="objective-c-コンパイラの設定" tabindex="-1">Objective-C++コンパイラの設定 <a class="header-anchor" href="#objective-c-コンパイラの設定" aria-label="Permalink to &quot;Objective-C++コンパイラの設定&quot;">​</a></h4><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    tool(&quot;objcxx&quot;) {</span></span>
<span class="line"><span>      depfile = &quot;{{output}}.d&quot;</span></span>
...
<span class="line"><span>      outputs = [ &quot;{{source_out_dir}}/{{target_output_name}}.{{source_name_part}}.o&quot; ]</span></span>
<span class="line"><span>      description = &quot;assemble {{source}}&quot;</span></span>
<span class="line"><span>    }</span></span></code></pre></div>`,2)),n("ul",null,[n("li",null,[s[65]||(s[65]=n("strong",null,"説明",-1)),s[66]||(s[66]=a(": ")),s[67]||(s[67]=n("code",null,"asm",-1)),s[68]||(s[68]=a(" ツール（アセンブラ）の設定を行います。 ")),n("ul",null,[s[64]||(s[64]=n("li",null,[n("code",null,"cc"),a(" コンパイラを使用してアセンブルを行います。")],-1)),n("li",null,[n("code",null,o(l.asmflags),1),s[63]||(s[63]=a(" を追加しています。"))])])])]),s[104]||(s[104]=p(`<h3 id="macおよびios用の設定" tabindex="-1">MacおよびiOS用の設定 <a class="header-anchor" href="#macおよびios用の設定" aria-label="Permalink to &quot;MacおよびiOS用の設定&quot;">​</a></h3><div class="language-gn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">gn</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>if (is_mac || is_ios) {</span></span>
