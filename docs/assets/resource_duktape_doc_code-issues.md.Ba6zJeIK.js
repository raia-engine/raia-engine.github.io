import{_ as t,c as o,a2 as a,o as i}from"./chunks/framework.DPuwY6B9.js";const h=JSON.parse('{"title":"コードの問題","description":"","frontmatter":{},"headers":[],"relativePath":"resource/duktape/doc/code-issues.md","filePath":"resource/duktape/doc/code-issues.md","lastUpdated":1732350347000}'),n={name:"resource/duktape/doc/code-issues.md"};function r(s,e,l,d,c,u){return i(),o("div",null,e[0]||(e[0]=[a(`<h1 id="コードの問題" tabindex="-1">コードの問題 <a class="header-anchor" href="#コードの問題" aria-label="Permalink to &quot;コードの問題&quot;">​</a></h1><p>本ドキュメントは、Duktapeの実装に関連するCコーディングの問題点をカバーしています。 のようなものです：</p><ul><li>Conventions</li><li>Portability concerns</li><li>Specific platforms and compilers</li><li>Size and performance optimization issues</li></ul><p>Some code conventions are checked by the <code>make codepolicycheck</code> target.</p><p>Source code is now formatted using clang-format so some of the conventions below are out-of-date.</p><h2 id="basic-conventions" tabindex="-1">Basic conventions <a class="header-anchor" href="#basic-conventions" aria-label="Permalink to &quot;Basic conventions&quot;">​</a></h2><h3 id="indentation-naming-etc" tabindex="-1">Indentation, naming, etc. <a class="header-anchor" href="#indentation-naming-etc" aria-label="Permalink to &quot;Indentation, naming, etc.&quot;">​</a></h3><p>Indent with tab. On continuation lines indent with tab to shared indent depth and then indent with spaces. For example, denoting tab indent with colon and space indent with period:</p><pre><code>::::::::snprintf(buf,
::::::::.........sizeof(buf), 
::::::::.........&quot;%d&quot;,
::::::::.........123);
